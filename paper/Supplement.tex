...
To address this limitation, we formulated a mechanistic resource depletion model in which the rate of resource consumption is driven by the cumulative biosynthetic flux. We define two dimensionless state variables: $\epsilon_X(t) \in [0,1]$, representing the fractional availability of consumable resources that sustain transcription, and $\epsilon_L(t) \in [0,1]$, representing the fractional availability of consumable resources that sustain translation, with $\epsilon_X(0) = \epsilon_L(0) = 1$. The depletion dynamics are governed by:
\begin{align}
