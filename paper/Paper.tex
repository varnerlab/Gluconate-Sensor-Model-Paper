...
Black circles represent experimental data with standard errors captured by error bars across at least three replicates. mRNA was measured using qPCR; Venus protein was measured on a plate reader (513 nm excitation/531 nm emission). The ParetoEnsembles.jl parameter ensemble ($N = 5000$) was used to calculate the mean (black line) and 95\% confidence estimate of the model simulation (shaded region). GntR protein (panel D) was predicted by the model and not experimentally measured.}\label{fig:model_training}
\end{figure}
...
\end{center}
\caption{Predicted trajectories of consumable resource availability over the 12-hour cell-free reaction. The transcriptional resource variable $\epsilon_X$ (representing the fractional availability of nucleotides and energy cofactors for transcription) and the translational resource variable $\epsilon_L$ (representing the fractional availability of amino acids and energy cofactors for translation) were computed from the mechanistic resource depletion model (Eqns.~\ref{eq:epsX}--\ref{eq:epsL}). By 12 hours, $\epsilon_X$ declined to 0.34 (66\% depletion) while $\epsilon_L$ declined to 0.91 (9\% depletion), indicating that transcriptional resources were the primary bottleneck. Lines represent the ensemble mean; shaded regions represent the 95\% confidence interval across the parameter ensemble ($N = 5000$).}\label{fig:resource_depletion}
\end{figure}
...
0 (control) & $1.83 \pm 0.14$ & 1.00$\times$ & -- & $1.83 \pm 0.14$ & 1.00$\times$ & -- \\
0.25 & $1.93 \pm 0.15$ & 1.05$\times$ & 130.4 & $1.84 \pm 0.14$ & 1.003$\times$ & 30.0 \\
0.50 & $2.03 \pm 0.17$ & 1.11$\times$ & 129.6 & $1.84 \pm 0.13$ & 1.006$\times$ & 29.9 \\
0.75 & $2.12 \pm 0.21$ & 1.16$\times$ & 128.8 & $1.85 \pm 0.13$ & 1.009$\times$ & 29.9 \\
1.00 & $2.22 \pm 0.25$ & 1.21$\times$ & 128.0 & $1.85 \pm 0.13$ & 1.012$\times$ & 29.9 \\
\bottomrule
\end{tabular}
...
& & & & \\
cRNAP + P70 pseudo-energy & $\epsilon_{P70,cRNAP}$ & $0.062 \pm 0.21$ & $k_BT$ & -- \\
hRNAP + P70 pseudo-energy & $\epsilon_{P70,hRNAP}$ & $-0.056 \pm 0.19$ & $k_BT$ & -- \\
cRNAP + mP70 pseudo-energy & $\epsilon_{mP70,cRNAP}$ & $1.31 \pm 1.67$ & $k_BT$ & -- \\
hRNAP + mP70 pseudo-energy & $\epsilon_{mP70,hRNAP}$ & $-0.044 \pm 0.083$ & $k_BT$ & -- \\
GntR + mP70 operator & $\epsilon_{mP70,GntR}$ & $-1.80 \pm 0.69$ & $k_BT$ & -- \\
& & & & \\
Hill coeff. P70 + hRNAP & $n_{P70,hRNAP}$ & $1.14 \pm 1.19$ & -- & -- \\
Dissoc. const. P70 + hRNAP & $K_{P70,hRNAP}$ & $4.43 \pm 15.0$ & $\mu$M & -- \\
Hill coeff. mP70 + hRNAP & $n_{mP70,hRNAP}$ & $1.80 \pm 1.84$ & -- & -- \\
Dissoc. const. mP70 + hRNAP & $K_{mP70,hRNAP}$ & $3.71 \pm 9.14$ & $\mu$M & -- \\
Hill coeff. mP70 + GntR & $n_{mP70,GntR}$ & $4.88 \pm 3.04$ & -- & -- \\
Dissoc. const. mP70 + GntR & $K_{mP70,GntR}$ & $0.066 \pm 0.10$ & $\mu$M & -- \\
& & & & \\
TX time const. GntR & $\tau_{X,GntR}$ & $1.67 \pm 2.26$ & -- & -- \\
TX time const. Venus & $\tau_{X,Venus}$ & $0.072 \pm 0.17$ & -- & -- \\
TL time const. GntR & $\tau_{L,GntR}$ & $9.73 \pm 10.4$ & -- & -- \\
TL time const. Venus & $\tau_{L,Venus}$ & $0.63 \pm 0.71$ & -- & -- \\
Deg. modifier mRNA GntR & $\delta_{m,GntR}$ & $0.020 \pm 0.015$ & -- & -- \\
Deg. modifier mRNA Venus & $\delta_{m,Venus}$ & $40.5 \pm 35.9$ & -- & -- \\
Deg. modifier protein GntR & $\delta_{p,GntR}$ & $0.041 \pm 0.087$ & -- & -- \\
Deg. modifier protein Venus & $\delta_{p,Venus}$ & $0.083 \pm 0.17$ & -- & -- \\
Deg. modifier protein $\sigma_{70}$ & $\delta_{p,\sigma_{70}}$ & $0.083 \pm 0.17$ & -- & -- \\
Translation saturation const. & $K_L$ & $469 \pm 280$ & $\mu$M & -- \\
& & & & \\
Hill coeff. gluconate-GntR & $n_{\text{gluconate}}$ & $2.28 \pm 1.13$ & -- & -- \\
Dissoc. const. gluconate-GntR & $K_{\text{gluconate}}$ & $0.30 \pm 0.31$ & mM & -- \\
& & & & \\
TX resource consumption rate & $\alpha_X$ & $(4.9 \pm 6.4) \times 10^{-5}$ & $(\mu\text{M}\cdot\text{nt}\cdot\text{hr})^{-1}$ & -- \\
TL resource consumption rate & $\alpha_L$ & $(2.3 \pm 5.2) \times 10^{-5}$ & $(\mu\text{M}\cdot\text{aa}\cdot\text{hr})^{-1}$ & -- \\
\bottomrule
\end{tabular}}
